...
from nanobot.agent.hook import rpg_hooks
...
def serve(
    ...
    agent_loop = AgentLoop(
        ...
        hooks=rpg_hooks(enable=runtime_config.agents.defaults.session_extra.enable_rpg_hooks),
    )
...
def _run_gateway(
    ...
    *,
    ...
    agent = AgentLoop(
        ...
        hooks=rpg_hooks(enable=config.agents.defaults.session_extra.enable_rpg_hooks),
